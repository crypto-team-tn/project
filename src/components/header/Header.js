        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent-3">
          <ul className="navbar-nav mr-auto">
            ...
            <li className="nav-item dropdown active">
              <a href="#!" className="nav-link dropdown-toggle" id="navbarDropdownMenuLink-3" data-toggle="dropdown"  aria-expanded="false">Tutorials 
              </a>
  ...
  <div className="container-fluid">
    <div className="row  justify-content-center align-items-center d-flex text-center h-100">
      <div className="col-12 col-md-8  h-50 ">
        ...
        <p><a href="#!" className="btn primary-btn shadow-lg btn-round text-light btn-lg btn-rised" style={{margin: '1%', padding:'2%'}}  >Explore Now <FontAwesomeIcon icon={["fal", "coffee"]} /></a>
